      ...
      <div className={`container ${styles.container}`}>
        <div className={`row justify-content-center ${styles.formWrapper}`}>
          <div className="col-md-6">
            ...
            <form className={styles.formContainer} onSubmit={handleSubmit(data => {
...
{/* 
              ...
              <div className="mb-3">
                ...
                />
                  {errors.lastname && <p style={{ color: 'red', fontSize: '13px'}}>{errors.lastname.message}</p>}
              </div>
              {/* Fin apellido */}
...
{/* 
              ...
              <div className="mb-3">
                ...
                <input type="date" id="age" name="age" className="form-control" 
                 {...register('age', {
                  required:{
                    value:true,
                 ...
                 const age = currentYear.getFullYear() - birthday.getFullYear()
                ...
                />
                 {errors.age && <p style={{ color: 'red', fontSize: '13px'}}>{errors.age.message}</p>}
              </div>
              {/* Fin edad */}

              {/* Descripción */}
              <div className="mb-3">
                <label htmlFor="personalDescription">Escribe una breve descripción sobre ti</label>
                <textarea
          ...
          <div className="col-md-6 align-self-center">
            <div className={`mb-3 text-center ${styles.imageContainer}`}>
              ...
              <UploadSimple
                  ...
                  weight="fill"
                />
                <label className={styles.labelFile} htmlFor="uploadImage">Selecciona una imágen</label>
              <input 
              ...
              <p>
                Tamaño recomendado: 120 px x 120 px. Peso máximo: 100 KB
              </p>
